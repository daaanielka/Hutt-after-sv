...
# Rodinná anamnéza (O sekcia) — >40% chýbajúcich hodnôt → vyradená
high_missing_cols  = ['O', 'O1', 'O2', 'O3', 'O4', 'O5']
...
if USE_MA_DIAG:
    ...
    ALL_REMOVE = (admin_cols + leakage_cols + post_test_cols +
                  ...
                  doctor_remove_cols + high_missing_cols + p_srdc_cols)
else:
    # P1–P7 ostávajú v poole ako samostatné binárne features
    ALL_REMOVE = (admin_cols + leakage_cols + post_test_cols +
                  flag_cols + poor_quality_cols + text_cols +
                  doctor_remove_cols + high_missing_cols)
...
print("  O sekcia (rodinná anamnéza) vyradená — >40% chýbajúcich hodnôt.")
